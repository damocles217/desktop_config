" Vim syntax file
" Language:     GNU as (AT&T) assembler for X8G
...
syn keyword gasDirecCond	.else .elseif .endef .endif .endr .equ .equiv .eqv .err .if 
...
" link to defaults
hi def link gasDirective	Preproc1
hi def link gasDirectiveStore	Type1
hi def link gasDirectiveMacro	Macro1
hi def link gasRegister		Identifier1
hi def link gasString		String1
hi def link gasDirecCond	Conditional1
hi def link gasCharacter	Character1
hi def link gasBinaryNumber	Constant1
hi def link gasOctalNumber	Constant1
hi def link gasHexNumber	Constant1
hi def link gasDecimalNumber	Constant1
hi def link gasSymbol		Function1
hi def link gasSymbolRef	Special1
hi def link gasSpecial		Special1
hi def link gasLabel		Function1
hi def link gasLocalLabel	Label1
hi def link gasOperator		Operator1
hi def link gasOpcode		Keyword1	
hi def link gasComment		Comment1
hi def link gasCommentSingle	Comment1
